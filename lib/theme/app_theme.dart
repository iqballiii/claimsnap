...
class AppTheme {
  ...
  // Professional Trust Palette - Insurance claim management colors
  ...
  static const Color accentLight = Color(0xFFE67E22); // Warm orange for alerts
  static const Color successLight =
      Color(0xFF27AE60); // Clear green for success
  static const Color warningLight = Color(0xFFF39C12); // Amber for warnings
  static const Color errorLight = Color(0xFFE74C3C); // Confident red for errors
  ...
  static const Color primaryDark =
      Color(0xFF4A90A4); // Supporting blue as primary
  static const Color primaryVariantDark = Color(0xFF357A8F); // Darker variant
  static const Color secondaryDark =
      Color(0xFF1B365D); // Deep blue as secondary
  static const Color secondaryVariantDark = Color(0xFF0F2A47); // Darker variant
  static const Color accentDark = Color(0xFFE67E22); // Same warm orange
  static const Color successDark = Color(0xFF27AE60); // Same green
  static const Color warningDark = Color(0xFFF39C12); // Same amber
  static const Color errorDark = Color(0xFFE74C3C); // Same red
  ...
  static const Color dividerLight = Color(0x1F2C3E50);
  ...
  /// Get monospace text style for data display (claim numbers, amounts)
  ...
  /// Get gradient for primary action buttons
  ...
  /// Get subtle status gradient for status indicators
